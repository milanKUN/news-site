      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
              ...
              $limit=2;
              $ofset=($page-1)*$limit;
              $sql="SELECT `post`.`post_id`, `POST`.`post_img`,`POST`.`author`,`POST`.`post_date`,`POST`.`category`,`POST`.`description`,`POST`.`title`,`category`.`category_name`,`user`.`first_name` FROM `post`
            ...
            <a class="post-img" href="single.php?id=<?php echo $row["post_id"]; ?>"><img src="admin/upload/<?php echo $row["post_img"]; ?>" alt=""/></a>
                ...
                $sql1="SELECT * FROM `post`where `post`.`category`= {$cid} ";
